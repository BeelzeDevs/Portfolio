...
const TimeLine = () =>{
    return(
        ...
        divide-y divide-slate-200 mb-10">
            <div className="w-full max-w-3xl mx-auto mb:pb-40 md:pt-10 px-5">

                {dataAboutPage.map(({id,title,subtitle,description,date})=>{
                    return(
                        <div key={id} className="relative py-6 pl-8 sm:pl-32 group">
                            <h3 className="mb-1 text-2xl font-bold sm:mb-0">{title}</h3>
                            ...
                            sm:after:left-0 after:w-2 after:h-2 after:bg-indigo
                            ...
                            after:translate-y-1.5">
                                ...
                                text-emerald-600 bg-emerald-100 rounded-full">{date}</time>
                                <p className="text-xl font-bold text-gray-400 ">
                                    {subtitle}
                                </p>
                            </div>
                                <p className="text-slade-400 max-w-md">{description}</p>
                        </div>
                    );
                })}
